  ...
  extends BlockDamaged
{
  public BlockSiliconeColored()
  {
    ...
    for (int i = 0; i < 16; i++)
    {
      addBlockList(net.minecraft.item.ItemDye.field_150921_b[net.minecraft.block.BlockColored.func_150031_c(i)], i);
      setTier(5);
      setSubBlockSurfix(net.minecraft.item.ItemDye.field_150921_b[net.minecraft.block.BlockColored.func_150031_c(i)]);

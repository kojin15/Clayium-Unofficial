  ...
  extends ClayNoRecipeMachines
{
  ...
  public void updatePower(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_)
  {
    ...
    {
      TileEntity tile = UtilBuilder.safeGetTileEntity(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_);
      if ((tile instanceof TileClayEnergyLaser)) {
        ((TileClayEnergyLaser)tile).setPowered(ClayiumCore.cfgInverseClayLaserRSCondition ? false : !p_149695_1_.isBlockIndirectlyGettingPowered(p_149695_2_, p_149695_3_, p_149695_4_) ? true : p_149695_1_.isBlockIndirectlyGettingPowered(p_149695_2_, p_149695_3_, p_149695_4_));
      }
    }
  }
  ...
  {
    List ret = UtilLocale.localizeTooltip("tooltip.ClayEnergyLaser");
    ...
    if (UtilLocale.canLocalize("tooltip.ClayEnergyLaser.energyConsumption"))
    {
      ...
      {
      case 7: 
        e = TileClayEnergyLaser.consumingEnergyBlue; break;
      case 8: 
        e = TileClayEnergyLaser.consumingEnergyGreen; break;
      case 9: 
        e = TileClayEnergyLaser.consumingEnergyRed; break;
      case 10: 

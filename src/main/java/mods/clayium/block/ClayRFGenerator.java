  ...
  extends ClayNoRecipeMachines
{
  ...
  public static Map<String, Object> getConfig(String blockName)
  {
    ...
    return map == null ? null : (Map)map.get(blockName);
  }
  
  protected static final Splitter splitter2 = Splitter.on(':');
  protected static final String[] keys = { "IconName", "Tier", "CEConsumptionPerTick", "RFProductionPerTick", "RFOutputPerTick", "RFStorageSize", "OverclockExponent" };
  protected static final Class[] valueTypes = { String.class, Integer.class, Long.class, Integer.class, Integer.class, Integer.class, Double.class };
  ...
  {
    List ret = UtilLocale.localizeTooltip("tooltip.RFGenerator");

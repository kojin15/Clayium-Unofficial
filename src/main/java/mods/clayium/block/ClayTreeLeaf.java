...
{
  public static final String[][] iconNames = { { "clayium:leaves_claytree", "leaves_big_oak" }, { "clayium:leaves_claytree_opaque", "leaves_big_oak_opaque" } };
  public static final String[] nameSuffix = { "claytree", "big_oak" };

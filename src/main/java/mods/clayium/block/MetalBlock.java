...
{
  public static Map<Integer, MetalBlock> metalBlockMap = new HashMap();
  ...
  public static void registerBlockMaterial(CMaterial material)
  {
    ...
    {
      MetalBlock block = new MetalBlock();
      GameRegistry.registerBlock(block, ItemBlockDamaged.class, "blockMetal" + String.format("%03d", new Object[] { Integer.valueOf(material.meta / 16) }));
      metalBlockMap.put(Integer.valueOf(material.meta / 16), block);
    }
  ...
  {
    return (MetalBlock)metalBlockMap.get(Integer.valueOf(material.meta / 16));
  }

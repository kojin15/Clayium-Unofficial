  ...
  implements ITieredBlock
{
  ...
  public void registerBlockIcons(IIconRegister par1IconRegister)
  {
    ...
    this.BackIcon = (this.LeftIcon = this.RightIcon = this.SideIcons[0] = new TextureExtra("clayium:storagecontainerside_", new String[] { this.machineIconStr, "clayium:storagecontainerside" }).register(par1IconRegister));
    ...
    this.UpIcon = (this.DownIcon = this.TopIcons[0] = new TextureExtra("clayium:storagecontainertop_", new String[] { this.machineIconStr, "clayium:storagecontainertop" }).register(par1IconRegister));

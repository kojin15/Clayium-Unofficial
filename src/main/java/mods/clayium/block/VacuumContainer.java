  ...
  implements ITieredBlock
{
  ...
  public void registerBlockIcons(IIconRegister par1IconRegister)
  {
    ...
    this.BackIcon = (this.LeftIcon = this.RightIcon = new TextureExtra("clayium:vacuumcontainerside_", new String[] { this.machineIconStr, "clayium:vacuumcontainerside" }).register(par1IconRegister));

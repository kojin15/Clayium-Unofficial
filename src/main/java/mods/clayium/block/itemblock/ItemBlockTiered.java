  ...
  implements ITieredItem
{
  ...
  public void addInformation(ItemStack itemstack, EntityPlayer player, List list, boolean flag)
  {
    ...
    {
      List alist = ((ISpecialToolTip)this.field_150939_a).getTooltip(itemstack);
      if (alist != null) {
        list.addAll(alist);
      }
    }
  ...
  {
    return ((UtilKeyInput.getKeyLength(p_77648_2_, PlayerKey.KeyType.SPRINT) >= 0) && (replace(p_77648_1_, p_77648_2_, p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_, p_77648_7_, p_77648_8_, p_77648_9_, p_77648_10_))) || ((ClayiumCore.IntegrationID.MULTI_PART.loaded()) && (UtilMultipart.onItemBlockMultipartUse(p_77648_1_, p_77648_2_, p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_, p_77648_7_, p_77648_8_, p_77648_9_, p_77648_10_))) || (place(p_77648_1_, p_77648_2_, p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_, p_77648_7_, p_77648_8_, p_77648_9_, p_77648_10_));
  }
  ...
  public boolean replace(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ)
  {
    ...
    if (((block instanceof IOverridableBlock)) && 
      (((IOverridableBlock)block).canOverride(itemStack, player, world, x, y, z, side, hitX, hitY, hitZ))) {
  ...
  {
    return (UtilKeyInput.getKeyLength(p_150936_6_, PlayerKey.KeyType.SPRINT) >= 0) || (canPlaceInClient(p_150936_1_, p_150936_2_, p_150936_3_, p_150936_4_, p_150936_5_, p_150936_6_, p_150936_7_));
  }
  ...
  public boolean canPlaceInClient(World p_150936_1_, int p_150936_2_, int p_150936_3_, int p_150936_4_, int p_150936_5_, EntityPlayer p_150936_6_, ItemStack p_150936_7_)
  {
    ...
    p_150936_2_ = coord[0];p_150936_3_ = coord[1];p_150936_4_ = coord[2];p_150936_5_ = coord[3];
    
    return ((ClayiumCore.IntegrationID.MULTI_PART.loaded()) && (UtilMultipart.placeMultipart(p_150936_1_, p_150936_2_, p_150936_3_, p_150936_4_, p_150936_7_, p_150936_5_, false))) || (p_150936_1_.canPlaceEntityOnSide(this.field_150939_a, p_150936_2_, p_150936_3_, p_150936_4_, false, p_150936_5_, (Entity)null, p_150936_7_));
  }
}

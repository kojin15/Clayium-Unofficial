  ...
  implements IRayTracer
{
  ...
  public void initParamsByTier(int tier)
  {
    ...
    case 6: 
      ...
      this.autoExtractInterval = (this.autoInsertInterval = 2); break;
    case 7: 
    ...
    if (!this.areaMode)
    {
      ...
      for (int i = 0; i < this.insertRoutes.length; i++) {
  ...
  public List<Entity> scannedEntityList = new ArrayList();
  ...
  public void doWork()
  {
    ...
    case 4: 
      ...
      if (this.scanningBlock)
      {
        long c = this.areaMode ? (this.energyPerTick * (1.0D + 4.0D * Math.log10(this.laserEnergy / 1000L + 1L))) : 0L;
        ...
        else if (consumeClayEnergy(c))
        {
          setSyncFlag();
          this.progress += (this.progressPerTick * (1.0D + 4.0D * Math.log10(this.laserEnergy / 1000L + 1L)));
          this.laserEnergy = 0L;
          ...
          long i = (this.progressPerJob * 1.0D);
          flag = true;
          for (int count = 0; count < max; count++)
          {
            ...
            if ((this.enableRayTrace) || (this.worldObj.getBlock(this.miningX, this.miningY, this.miningZ) == Blocks.air))
            {
              ...
              else
              {
                ...
                MovingObjectPosition mop = pos.distanceTo(mopBlock.hitVec) < pos.distanceTo(mopEntity.hitVec) ? mopBlock : mopEntity == null ? mopBlock : mopBlock == null ? mopEntity : mopEntity;
      ...
      {
        long c = (this.energyPerTick * (1.0D + 4.0D * Math.log10(this.laserEnergy / 1000L + 1L)));
  ...
  public void pushButton(EntityPlayer player, int action)
  {
    ...
    case 4: 
      ...
      break;
    case 5: 
      this.enableRayTrace = (!this.enableRayTrace); break;
    case 6: 
  ...
  public void writeWorkdataToNBT(NBTTagCompound tagCompound)
  {
    ...
    if (this.rayTraceMemory != null)
    {
      ...
      tagCompound.setTag("RayTraceMemory", tag);
    }
  }

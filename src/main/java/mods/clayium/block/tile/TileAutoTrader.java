  ...
  extends TileClayContainerTiered
{
  ...
  public void updateEntity()
  {
    ...
    {
      List list = this.worldObj.selectEntitiesWithinAABB(IMerchant.class, AxisAlignedBB.getBoundingBox(this.xCoord, this.yCoord + 1, this.zCoord, this.xCoord + 1, this.yCoord + 3, this.zCoord + 1), IEntitySelector.selectAnything);
      if (!list.isEmpty())
      {
  ...
  public void pushButton(EntityPlayer player, int action)
  {
    ...
    {
    case 1: 
      setCurrentRecipeIndex(this.currentRecipeIndex + 1); break;
    case 2: 

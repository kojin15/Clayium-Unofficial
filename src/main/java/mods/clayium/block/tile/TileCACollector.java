  ...
  implements INormalInventory
{
  ...
  {
    this.machineTimeToCraft = (((float)this.baseCraftTime * this.multCraftTime));
    this.machineCraftTime = ((this.machineCraftTime + ClayiumCore.multiplyProgressionRateD(getResonance() - 1.0D)));

  ...
  implements INormalInventory
{
  ...
  public void initParamsByTier(int tier)
  {
    ...
    {
    case 4: 
      this.inventoryX = (1 + (this.inventoryY = 1)); break;
    case 5: 
      this.inventoryX = (1 + (this.inventoryY = 2)); break;
    case 6: 
      this.inventoryX = (1 + (this.inventoryY = 3)); break;
    case 7: 
      this.inventoryX = (1 + (this.inventoryY = 4)); break;
    case 8: 
      this.inventoryX = (5 + (this.inventoryY = 4)); break;
    case 9: 
    case 10: 
    case 11: 
    case 12: 
    case 13: 
      this.inventoryX = (3 + (this.inventoryY = 6)); break;
    default: 

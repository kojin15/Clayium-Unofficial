  ...
  implements ISynchronizedInterface
{
  ...
  protected boolean syncCoreBlock(int x, int y, int z)
  {
    ...
    {
      TileEntity te;
      if ((((te = UtilBuilder.safeGetTileEntity(getCoreWorld(), coreX, coreY, coreZ)) instanceof TileClayContainer)) && 
    ...
    this.listSlotsInsert = new ArrayList();this.listSlotsInsert.add(new int[] { 0 });
    this.listSlotsExtract = new ArrayList();this.listSlotsExtract.add(new int[] { 0 });
    this.slotsDrop = new int[0];

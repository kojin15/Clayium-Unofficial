  ...
  implements IEnergyProvider
{
  ...
  public void updateEntity()
  {
    ...
    {
      block = this.worldObj.getBlock(this.xCoord + direction.offsetX, this.yCoord + direction.offsetY, this.zCoord + direction.offsetZ);
    ...
    this.ceConsumptionPerTick = (d >= 9.223372036854776E18D ? Long.MAX_VALUE : d);
    ...
    if (!isPowered()) {
      for (ForgeDirection direction : ForgeDirection.VALID_DIRECTIONS) {
        ...
        {
          TileEntity tile = UtilDirection.getTileEntity(this.worldObj, this.xCoord, this.yCoord, this.zCoord, direction);

  ...
  implements IClayLaserMachine
{
  ...
  protected void onDestruction()
  {
    ...
    this.containerItemStacks[4] = (this.containerItemStacks[5] = null);
  }
  ...
  protected int getMachineTier(int xx, int yy, int zz)
  {
    ...
    if (block == CBlocks.blockOverclocker)
    {
      ...
      return CBlocks.blockOverclocker.getTier(this.worldObj, coord[0], coord[1], coord[2]);
    }
    TileEntity te = getTileEntity(xx, yy, zz);
  ...
  public void proceedCraft()
  {
    ...
    if ((this.containerItemStacks[4] == null) && (this.containerItemStacks[5] == null))
    {
      ...
      this.machineConsumingEnergy = (((float)this.recipe.getEnergy(itemstacks, method, this.recipeTier) * this.multConsumingEnergy));
    }
    if (consumeClayEnergy(this.machineConsumingEnergy))
    {
      if ((this.containerItemStacks[4] == null) && (this.containerItemStacks[5] == null))
      {
        ...
        this.machineTimeToCraft = (((float)this.recipe.getTime(itemstacks, method, this.recipeTier) * this.multCraftTime));
      ...
      {
        this.machineCraftTime += this.irradiatedLaser.getEnergy();

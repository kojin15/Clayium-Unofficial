  ...
  implements ISidedInventory
{
  ...
  public void updateEntity()
  {
    ...
    if (!this.worldObj.isRemote) {
      if (this.ticket == null)
      {
        this.ticket = ForgeChunkManager.requestTicket(ClayiumCore.INSTANCE, this.worldObj, Type.NORMAL);
  ...
  public void transfer(TileEntity from, int[] fromSlots, ForgeDirection direction, int maxTransfer)
  {
    ...
    TileEntity te = UtilDirection.getTileEntity(from.getWorldObj(), from.xCoord, from.yCoord, from.zCoord, direction);
    ...
    {
      int[] toSlots = new int[to.getSizeInventory()];
  ...
  private boolean canKnead(ItemStack material, int method)
  {
    ...
    {
      if (!this.furnaceItemStacks[3].isItemEqual(itemstack2)) {
        return false;
      }
  ...
  public void pushButton(int buttonid)
  {
    ...
    if (canpushbutton == 1)
    {
      ...
      if (this.furnaceCookTime >= this.furnaceTimeToCook)
      {
        ...
        if (this.furnaceItemStacks[4].stackSize -= consumedStackSize <= 0) {
      ...
      else
      {
        ...
        if (merchantrecipelist != null)
        {
          ...
          if ((merchantrecipe != null) || (
            ...
            (merchantrecipe != null) && (!merchantrecipe.isRecipeDisabled())))
          {

  ...
  implements IGeneralInterface
{
  ...
  public void updateEntity()
  {
    ...
    if ((this.worldObj.isRemote) && ((this.strongReRenderFlag) || ((this.weakReRenderFlag) && (this.worldObj.getTotalWorldTime() % ClayiumCore.cfgRenderingRate == 0L))))
    {
      ...
      this.weakReRenderFlag = (this.strongReRenderFlag = 0);
    }
  }
  ...
  public void useItem(ItemStack itemStack, EntityPlayer player, int direction, float hitX, float hitY, float hitZ)
  {
    ...
    {
      side = UtilDirection.direction2Side(getFrontDirection(), direction) - 6;
    ...
    {
      TileEntity tile = UtilDirection.getTileEntity(this.worldObj, this.xCoord, this.yCoord, this.zCoord, direction1);
  ...
  public static void writeTileEntityTagToItemStack(ItemStack item, TileEntity tile)
  {
    if ((item != null) && (tile != null))
    {
      ...
      tetag.removeTag("x");tetag.removeTag("y");tetag.removeTag("z");
  ...
  public static void readTileEntityTagFromItemStack(ItemStack item, TileEntity tile, int x, int y, int z)
  {
    ...
    if (tetag != null)
    {
      tetag.setInteger("x", x);tetag.setInteger("y", y);tetag.setInteger("z", z);
  ...
  public Packet getDescriptionPacket()
  {
      ...
      for (Object o : keys) {
        if ((o instanceof String))
        {
          ...
          else
          {
            ...
            deletedList.appendTag(new NBTTagString(key));
          }
        }
      }
      if (deletedList != null) {
        tagToSend.setTag("__DeletedTags", deletedList);
      }
    }
    this.oldSendedTag = ((NBTTagCompound)nbtTagCompound.copy());
    if (this.renderSyncFlag)
    ...
    return new S35PacketUpdateTileEntity(this.xCoord, this.yCoord, this.zCoord, 1, tagToSend);
  }
  ...
  public void onDataPacket(NetworkManager net, S35PacketUpdateTileEntity pkt)
  {
    ...
    if (tagReceived.hasKey("__DeletedTags"))
    {
      ...
      for (i = 0; i < deletedList.tagCount(); i++) {

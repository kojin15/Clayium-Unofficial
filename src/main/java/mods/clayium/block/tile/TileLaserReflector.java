...
public class TileLaserReflector
  ...
  implements IClayLaserMachine, IClayLaserManager
{
  ...
  public TileLaserReflector()
  {
    ...
    this.autoInsert = false;this.autoExtract = false;
  ...
  public void updateEntity()
  {
    ...
    for (int i = 0; i < this.listIrradiatedClayLasers.size(); i++) {
      if (((Long)this.irradiatedTime.get(i)).longValue() != time)
      {
        array[j] = ((ClayLaser)this.listIrradiatedClayLasers.get(i));
        j++;
        flag = true;
      }
      else

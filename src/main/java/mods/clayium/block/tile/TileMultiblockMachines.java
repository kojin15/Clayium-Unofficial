  ...
  extends TileClayMachines
{
  ...
  protected TileEntity getTileEntity(int xx, int yy, int zz)
  {
    ...
    return this.worldObj == null ? null : UtilBuilder.safeGetTileEntity(this.worldObj, coord[0], coord[1], coord[2]);
  }
  ...
  protected int getBlockTier(int xx, int yy, int zz)
  {
    ...
    return (block != null) && ((block instanceof ITieredBlock)) ? ((ITieredBlock)block).getTier(this.worldObj, coord[0], coord[1], coord[2]) : -1;
  }

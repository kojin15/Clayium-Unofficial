...
import mods.clayium.util.UtilTransfer.InventorySelector;
  ...
  implements IMultitrackInventory
{
  ...
  public void initParamsByTier(int tier)
  {
    ...
    int trackNum = 6;int trackInvSize = 9;
    switch (tier)
    {
    case 4: 
      trackNum = 2;trackInvSize = 1; break;
    case 5: 
      trackNum = 3;trackInvSize = 2; break;
    case 6: 
      trackNum = 4;trackInvSize = 4; break;
    case 7: 
      trackNum = 5;trackInvSize = 4; break;
    case 8: 
      trackNum = 6;trackInvSize = 6; break;
    case 9: 
    case 10: 
    case 11: 
    case 12: 
    case 13: 
      trackNum = 6;trackInvSize = 9;
    }
    ...
    for (int i = 0; i < this.slot2track.length; i++) {
      this.slot2track[i] = -1;
    }
    for (int t = 0; t < trackNum; t++)
    {
      ...
      for (int i = 0; i < slots.length; i++)
      {
        slots[i] = (i + t * trackInvSize);
        slots2[i] = (slots.length - i - 1 + t * trackInvSize);
        this.slot2track[(i + t * trackInvSize)] = t;
      }
      this.listSlotsInsert.add(slots);
      this.listSlotsExtract.add(slots2);

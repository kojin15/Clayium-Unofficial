  ...
  implements IProjectile
{
  ...
  public void setThrowableHeading(double directionX, double directionY, double directionZ, float velocity, float diffusion)
  {
    ...
    this.prevRotationYaw = (this.rotationYaw = (float)(Math.atan2(directionX, directionZ) * 180.0D / 3.141592653589793D));
    this.prevRotationPitch = (this.rotationPitch = (float)(Math.atan2(directionY, f3) * 180.0D / 3.141592653589793D));
    this.ticksInGround = 0;
  }
  ...
  public void setVelocity(double motionX, double motionY, double motionZ)
  {
    ...
    if ((this.prevRotationPitch == 0.0F) && (this.prevRotationYaw == 0.0F))
    {
      ...
      this.prevRotationPitch = (this.rotationPitch = (float)(Math.atan2(motionY, f) * 180.0D / 3.141592653589793D));
    }
  }
  ...
  public void onUpdatePer()
  {
    ...
    {
      Entity entity = null;
      List list = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.addCoord(this.motionX * 10.0D, this.motionY * 10.0D, this.motionZ * 10.0D).expand(1.0D, 1.0D, 1.0D));
      double d0 = 0.0D;
  ...
  {
    this.worldObj.playSoundAtEntity(this.thrower, "fireworks.twinkle", 10.0F, 1.0F);
  }

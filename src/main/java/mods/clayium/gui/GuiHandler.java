  ...
  implements IGuiHandler
{
  public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
  {
    ...
    TileEntity tile = world != null ? UtilBuilder.safeGetTileEntity(world, x, y, z) : null;
    ...
    case 90: 
      return tile == null ? null : new ContainerNothing(playerInv, (TileClayRFGenerator)tile, 90);
    case 99: 
      TileClayContainerInterface ti = (TileClayContainerInterface)tile;
      if (!ti.isSynced()) {
        return null;
      }
      Block cblock = ti.getCoreWorld().getBlock(x + ti.getCoreBlockXCoord(), y + ti.getCoreBlockYCoord(), z + ti.getCoreBlockZCoord());
  ...
  {
    Block block = null;TileEntity tile = null;
    World world1 = world;
    if (world1 != null)
    {
      block = world1.getBlock(x, y, z);
      tile = UtilBuilder.safeGetTileEntity(world1, x, y, z);
    }
    InventoryPlayer playerInv = player != null ? player.inventory : null;
    switch (ID)
    {
    ...
    case 30: 
      ...
      GuiTemp container = new GuiClayCraftingTable(ContainerClayCraftingTable.newInstance(playerInv, (TileClayContainer)tile, block), (TileClayContainer)tile, block);
    ...
    case 2: 
      return tile == null ? null : new GuiClayMachines(new ContainerClayAssembler(playerInv, (TileClayMachines)tile, block), (TileClayMachines)tile, block);
    case 4: 
      return tile == null ? null : new GuiClayMachines(new ContainerClayChemicalReactor(playerInv, (TileClayChemicalReactor)tile, block), (TileClayMachines)tile, block);
    case 9: 
      return tile == null ? null : new GuiCAReactor(new ContainerClayMachines(playerInv, (TileClayMachines)tile, block), (TileCAReactor)tile, block);
    case 7: 
      return tile == null ? null : new GuiClayBlastFurnace(new ContainerClayChemicalReactor(playerInv, (TileClayBlastFurnace)tile, block), (TileClayBlastFurnace)tile, block);
    case 8: 
      return tile == null ? null : new GuiClayReactor(new ContainerClayChemicalReactor(playerInv, (TileClayReactor)tile, block), (TileClayReactor)tile, block);
    case 3: 
      return tile == null ? null : new GuiClayMachines(new ContainerClayCentrifuge(playerInv, (TileClayCentrifuge)tile, block), (TileClayMachines)tile, block);
    case 6: 
    ...
    case 40: 
      return tile == null ? null : new GuiPANAdapter(new ContainerPANAdapter(playerInv, (TilePANAdapter)tile, block), (TilePANAdapter)tile, block);
    case 41: 
      return tile == null ? null : new GuiPANCore(new ContainerPANCore(playerInv, (TilePANCore)tile, block), (TilePANCore)tile, block);
    case 10: 
    ...
    case 90: 
      return tile == null ? null : new GuiClayRFGenerator(new ContainerNothing(playerInv, (TileClayRFGenerator)tile, 90), (TileClayRFGenerator)tile, block);
    case 99: 
      TileClayContainerInterface ti = (TileClayContainerInterface)tile;
      if (!ti.isSynced()) {
        return null;

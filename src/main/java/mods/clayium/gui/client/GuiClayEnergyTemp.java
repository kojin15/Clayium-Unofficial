  ...
  extends GuiClayContainerTemp
{
  ...
  protected void drawClayEnergyForegroundLayer()
  {
    ...
    this.fontRendererObj.drawString(I18n.format("gui.Common.energy", new Object[] { UtilLocale.ClayEnergyNumeral(this.tile.clayEnergy, false) }), 4, container.machineGuiSizeY - 12, 4210752);
  }

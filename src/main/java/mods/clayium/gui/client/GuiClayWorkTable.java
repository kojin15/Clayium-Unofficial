  ...
  extends GuiContainer
{
  ...
  {
    super(new ContainerClayWorkTable(x, y, z));
  }
  ...
  protected void actionPerformed(GuiButton guibutton)
  {
    ...
    ClayiumCore.packetDispatcher.sendToServer(new GuiButtonPacket(this.tileClayWorkTable.xCoord, this.tileClayWorkTable.yCoord, this.tileClayWorkTable.zCoord, guibutton.id));
  ...
  public void drawScreen(int mousex, int mousey, float p_73863_3_)
  {
    ...
    if (ClayiumCore.IntegrationID.NEI.loaded())
    {
      ...
      if ((offsetX + progressBarPosX <= mousex) && (offsetY + progressBarPosY <= mousey) && (offsetX + progressBarPosX + progressBarSizeX > mousex) && (offsetY + progressBarPosY + progressBarSizeY > mousey))
      {
        List list = new ArrayList();list.add("Recipes");

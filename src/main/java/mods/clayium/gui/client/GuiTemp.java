  ...
  extends GuiContainer
{
  ...
  protected void drawGuiContainerForegroundLayer(int mouseX, int mouseZ)
  {
    ...
    if (drawPlayerInventoryName()) {
      this.fontRendererObj.drawString(I18n.format("container.inventory", new Object[0]), container.playerSlotOffsetX + 8, container.playerSlotOffsetY, 4210752);
    }
  }
  ...
  protected void drawGuiContainerBackgroundLayer(float partialTick, int mouseX, int mouseZ)
  {
    ...
    if (this.backTexture == null)
    {
      if (!this.initTextureSize)
      {
        ...
        this.tlw = getTextureWidth();this.tlh = getTextureHeight();
        this.mc.getTextureManager().bindTexture(DefaultTextureTopRight);
        this.trw = getTextureWidth();this.trh = getTextureHeight();
        this.mc.getTextureManager().bindTexture(DefaultTextureBottomLeft);
        this.blw = getTextureWidth();this.blh = getTextureHeight();
        this.mc.getTextureManager().bindTexture(DefaultTextureBottomRight);
        this.brw = getTextureWidth();this.brh = getTextureHeight();
    ...
    {
      Slot slot = (Slot)container.machineInventorySlots.get(i);
      ...
      else
      {
        ...
        int slotSizeX = 18;int slotSizeY = 18;
        int slotTextureX = 0;int slotTextureY = 0;
  ...
  protected void keyTyped(char c, int key)
  {
    ...
    {
      GuiTextField textField = (GuiTextField)this.textFields.get(i);
  ...
  public void setTextFieldString(String string, int id, boolean sendToContainer)
  {
    ...
    GuiTextField textField = (GuiTextField)this.textFields.get(id);

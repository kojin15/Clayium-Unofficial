  ...
  public void setMachineInventorySlots(InventoryPlayer player)
  {
    ...
    for (int j = 0; j < inventoryY; j++) {
      for (int i = 0; i < inventoryX; i++) {
        addMachineSlotToContainer(new Slot(tile, i + j * inventoryX, i * 18 + (this.machineGuiSizeX - 18 * inventoryX) / 2, j * 18 + 18)
        {
    ...
    addMachineSlotToContainer(new SlotMemory(tile, 21, 108 + (this.machineGuiSizeX - 18 * inventoryX) / 2, 18, RectangleTexture.SmallSlotEClayTexture));
  }

  ...
  extends ContainerClayMachines
{
  ...
  public void setMachineInventorySlots(InventoryPlayer player)
  {
    ...
    addMachineSlotToContainer(new SlotResultWithTexture(this.tile, 2, 110, 35, RectangleTexture.SmallSlotExport1Texture));
    addMachineSlotToContainer(new SlotResultWithTexture(this.tile, 3, 128, 35, RectangleTexture.SmallSlotExport2Texture));
  }
}

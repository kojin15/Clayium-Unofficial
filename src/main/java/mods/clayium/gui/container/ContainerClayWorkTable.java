  ...
  extends Container
{
  ...
  public ContainerClayWorkTable(InventoryPlayer player, TileClayWorkTable tileEntityClayWorkTable)
  {
    ...
    addSlotToContainer(new Slot(tileEntityClayWorkTable, 0, 17, 30));
    addSlotToContainer(new Slot(tileEntityClayWorkTable, 1, 80, 17));
    addSlotToContainer(new SlotFurnace(player.player, tileEntityClayWorkTable, 2, 143, 30));
    addSlotToContainer(new SlotFurnace(player.player, tileEntityClayWorkTable, 3, 143, 55));
    for (int i = 0; i < 3; i++) {
      for (int j = 0; j < 9; j++) {

  ...
  extends ContainerTemp
{
  ...
  {
    super(player.inventory, null, null, new Object[] { Integer.valueOf(inventoryX), Integer.valueOf(inventoryY), tagName });
    this.player = player;
  }
  ...
  protected void initParameters(InventoryPlayer player)
  {
    ...
    this.tile = new InventoryInItemStack(player.getCurrentItem(), this.tagName, this.inventoryX * this.inventoryY);

  ...
  extends ContainerTemp
{
  ...
  public void setMachineInventorySlots(InventoryPlayer player)
  {
    ...
    addMachineSlotToContainer(new SlotStorageContainer(tile, tile.extractSlotNum + tile.insertSlotNum - 1, 44, 35, RectangleTexture.LargeSlotTexture));
    addMachineSlotToContainer(new SlotResultWithTexture(tile, tile.extractSlotNum + tile.insertSlotNum, 116, 35, RectangleTexture.LargeSlotTexture));

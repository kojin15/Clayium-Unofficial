...
public class CItems
{
  ...
  public static void registerItems()
  {
    ...
    itemClayWrench = new ItemTiered()
    {
      ...
      .setCreativeTab(ClayiumCore.creativeTabClayium)
      .setUnlocalizedName("itemClayWrench").setTextureName("clayium:claywrench").setMaxStackSize(1).setFull3D();
    ...
    itemFilterDuplicator = new ItemFilterDuplicator().setBaseTier(7).setCreativeTab(ClayiumCore.creativeTabClayium).setUnlocalizedName("itemFilterDuplicator").setTextureName("clayium:filterduplicator");
    GameRegistry.registerItem(itemFilterDuplicator, "itemFilterDuplicator");
    
    itemFilterWhitelist = new ItemFilterWhitelist().setBaseTier(5).setCreativeTab(ClayiumCore.creativeTabClayium).setUnlocalizedName("itemFilterWhitelist").setTextureName("clayium:filterwhitelist");
    GameRegistry.registerItem(itemFilterWhitelist, "itemFilterWhitelist");
    
    itemFilterBlacklist = new ItemFilterBlacklist().setBaseTier(5).setCreativeTab(ClayiumCore.creativeTabClayium).setUnlocalizedName("itemFilterBlacklist").setTextureName("clayium:filterblacklist");
    GameRegistry.registerItem(itemFilterBlacklist, "itemFilterBlacklist");
    
    itemFilterFuzzy = new ItemFilterWhitelist(true).setBaseTier(7).setCreativeTab(ClayiumCore.creativeTabClayium).setUnlocalizedName("itemFilterFuzzy").setTextureName("clayium:filterfuzzy");
    GameRegistry.registerItem(itemFilterFuzzy, "itemFilterFuzzy");
    
    itemFilterOreDict = new ItemFilterOreDict().setBaseTier(6).setCreativeTab(ClayiumCore.creativeTabClayium).setUnlocalizedName("itemFilterOreDict").setTextureName("clayium:filterod");
    GameRegistry.registerItem(itemFilterOreDict, "itemFilterOreDict");
    
    itemFilterItemName = new ItemFilterItemName().setBaseTier(6).setCreativeTab(ClayiumCore.creativeTabClayium).setUnlocalizedName("itemFilterItemName").setTextureName("clayium:filtername");
    GameRegistry.registerItem(itemFilterItemName, "itemFilterItemName");
    
    itemFilterUnlocalizedName = new ItemFilterUnlocalizedName().setBaseTier(6).setCreativeTab(ClayiumCore.creativeTabClayium).setUnlocalizedName("itemFilterUnlocalizedName").setTextureName("clayium:filteruname");
    GameRegistry.registerItem(itemFilterUnlocalizedName, "itemFilterUnlocalizedName");
    
    itemFilterUniqueId = new ItemFilterUniqueID().setBaseTier(6).setCreativeTab(ClayiumCore.creativeTabClayium).setUnlocalizedName("itemFilterUniqueId").setTextureName("clayium:filterid");
    GameRegistry.registerItem(itemFilterUniqueId, "itemFilterUniqueId");
    
    itemFilterModId = new ItemFilterModID().setBaseTier(6).setCreativeTab(ClayiumCore.creativeTabClayium).setUnlocalizedName("itemFilterModId").setTextureName("clayium:filtermodid");
    GameRegistry.registerItem(itemFilterModId, "itemFilterModId");
    
    itemFilterItemDamage = new ItemFilterItemDamage().setBaseTier(6).setCreativeTab(ClayiumCore.creativeTabClayium).setUnlocalizedName("itemFilterItemDamage").setTextureName("clayium:filtermeta");
    GameRegistry.registerItem(itemFilterItemDamage, "itemFilterMetadata");
    
    itemFilterBlockMetadata = new ItemFilterBlockMetadata().setBaseTier(6).setCreativeTab(ClayiumCore.creativeTabClayium).setUnlocalizedName("itemFilterBlockMetadata").setTextureName("clayium:filterblockmeta");
    ...
    itemsClayShooter[0] = new ClayShooter(10000, "itemClayShooter0", "clayshooter0", 2, 1.2F, 25.0F, 4, 6, 0)
      .setBaseTier(6);
    GameRegistry.registerItem(itemsClayShooter[0], "itemClayShooter0");
    
    itemsClayShooter[1] = new ClayShooter(1000, "itemClayShooter1", "clayshooter1", 4, 4.5F, 3.0F, 7, 12, 0)
      .setBaseTier(6);
    GameRegistry.registerItem(itemsClayShooter[1], "itemClayShooter1");
    
    itemsClayShooter[2] = new ClayShooter(8000, "itemClayShooter2", "clayshooter2", 2, 15.0F, 0.0F, 25, 8, 20)
      .setBaseTier(6);
    GameRegistry.registerItem(itemsClayShooter[2], "itemClayShooter2");
    
    itemsClayShooter[3] = new ClayShooter(2500, "itemClayShooter3", "clayshooter3", 3, 30.0F, 0.0F, 100, 8, 40)
      .setBaseTier(6);
    ...
    itemDirectionMemory = new ItemTiered()
    {
      ...
      .setMaxStackSize(1).setTextureName("clayium:directionmemory");
    ...
    itemGadget.addItemList("AutoEat1", 49, "gadget_autoeat1", 7); ItemGadget 
      tmp2229_2226 = itemGadget;tmp2229_2226.getClass();IItemCallback callback = new ItemGadget.ItemCallbackItemFilterGui(tmp2229_2226);

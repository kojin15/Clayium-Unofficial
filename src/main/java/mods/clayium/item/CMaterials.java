...
{
  public static Map<CMaterial, Map<CShape, ItemStack>> materialShapeMap = new HashMap();
  public static Map<CMaterial, ItemDamaged> materialMap = new HashMap();
  public static Map<CShape, ItemDamaged> shapeMap = new HashMap();
  public static Map<Integer, CMaterial> materialList = new HashMap();
  ...
  public static void registerMaterials()
  {
    if (!ClayiumCore.cfgUtilityMode)
    {
      ...
      add(CLAY, PLATE);setTier(1);
      add(CLAY, STICK);setTier(1);
      add(CLAY, SHORT_STICK, "shortclaystick");setTier(1);
      add(CLAY, RING);setTier(1);
      add(CLAY, SMALL_RING, "smallclayring");setTier(1);
      add(CLAY, GEAR);setTier(1);
      add(CLAY, BLADE);setTier(1);
      add(CLAY, NEEDLE);setTier(1);
      add(CLAY, DISC);setTier(1);
      add(CLAY, SMALL_DISC, "smallclaydisc");setTier(1);
      add(CLAY, CYLINDER);setTier(1);
      add(CLAY, PIPE);setTier(1);
      add(CLAY, LARGE_BALL, "largeclayball");setTier(1);
      add(CLAY, LARGE_PLATE, "largeclayplate");setTier(1);
      add(CLAY, GRINDING_HEAD);setTier(1);
      add(CLAY, BEARING);setTier(1);
      add(CLAY, SPINDLE);setTier(1);
      add(CLAY, CUTTING_HEAD);setTier(1);
      add(CLAY, WATER_WHEEL);setTier(1);
      registerMaterialShape(CLAY, BLOCK, new ItemStack(Blocks.clay));
      registerMaterialShape(CLAY, BALL, new ItemStack(Items.clay_ball));
      
      add(DENSE_CLAY, PLATE);setTier(2);
      add(DENSE_CLAY, STICK);setTier(2);
      add(DENSE_CLAY, SHORT_STICK, "shortdenseclaystick");setTier(2);
      add(DENSE_CLAY, RING);setTier(2);
      add(DENSE_CLAY, SMALL_RING, "smalldenseclayring");setTier(2);
      add(DENSE_CLAY, GEAR);setTier(2);
      add(DENSE_CLAY, BLADE);setTier(2);
      add(DENSE_CLAY, NEEDLE);setTier(2);
      add(DENSE_CLAY, DISC);setTier(2);
      add(DENSE_CLAY, SMALL_DISC, "smalldenseclaydisc");setTier(2);
      add(DENSE_CLAY, CYLINDER);setTier(2);
      add(DENSE_CLAY, PIPE);setTier(2);
      add(DENSE_CLAY, LARGE_PLATE, "largedenseclayplate");setTier(2);
      add(DENSE_CLAY, GRINDING_HEAD);setTier(2);
      add(DENSE_CLAY, BEARING);setTier(2);
      add(DENSE_CLAY, SPINDLE);setTier(2);
      add(DENSE_CLAY, CUTTING_HEAD);setTier(2);
      add(DENSE_CLAY, WATER_WHEEL);setTier(2);
      ...
      add(IND_CLAY, PLATE);setTier(3);
      add(IND_CLAY, LARGE_PLATE);setTier(3);
      registerMaterialShape(IND_CLAY, BLOCK, new ItemStack(CBlocks.blockCompressedClay, 1, 2));
      
      add(ADVIND_CLAY, PLATE);setTier(4);
      add(ADVIND_CLAY, LARGE_PLATE);setTier(4);
      registerMaterialShape(ADVIND_CLAY, BLOCK, new ItemStack(CBlocks.blockCompressedClay, 1, 3));
      
      add(CLAY, DUST);setTier(1);
      add(DENSE_CLAY, DUST);setTier(2);
      addOD(IND_CLAY, DUST, false, true);setTier(3);
      addOD(ADVIND_CLAY, DUST, false, true);setTier(4);
      addOD(ENG_CLAY, DUST, false, true);setTier(3);
      
      addOD(EXC_CLAY, DUST, false, true);setTier(7);
      
      addOD(SALT, DUST, false, true);setTier(4);
      add(CAL_CLAY, DUST);setTier(4);
      add(CALCIUM_CHLORIDE, DUST);setTier(4);
      add(SODIUM_CARBONATE, DUST);setTier(4);
      addOD(QUARTZ, DUST, false, true);setTier(4);
      
      addOD(IMPURE_SILICON, DUST, true, true);setTier(5);
      addOD(IMPURE_SILICON, INGOT, false, true);setTier(5);
      addOD(IMPURE_SILICON, PLATE, false, true);setTier(5);
      add(IMPURE_SILICON, LARGE_PLATE);setTier(5);
      
      addOD(SILICONE, DUST, true, true);setTier(5);
      addOD(SILICONE, INGOT, true, true);setTier(5);
      addOD(SILICONE, PLATE, true, true);setTier(5);
      add(SILICONE, LARGE_PLATE, true);setTier(5);
      
      addOD(SILICON, DUST, true, true);setTier(5);
      addOD(SILICON, INGOT, true, true);setTier(5);
      addOD(SILICON, PLATE, true, true);setTier(5);
      add(SILICON, LARGE_PLATE, true);setTier(5);
      
      addOD(ALUMINIUM, DUST, true, true);setTier(6);
      addOD(ALUMINIUM, INGOT, true, true);setTier(6);
      addOD(ALUMINIUM, PLATE, true, true);setTier(6);
      add(ALUMINIUM, LARGE_PLATE, true);setTier(6);
      
      boolean cfg = ClayiumCore.cfgHardcoreAluminium;
      if (cfg) {
        setTier(IMPURE_ALUMINIUM, DUST, 6);
      }
      add(IMPURE_ALUMINIUM, INGOT, true, cfg);setTier(6);
      add(IMPURE_ALUMINIUM, PLATE, true, cfg);setTier(6);
      add(IMPURE_ALUMINIUM, LARGE_PLATE, true, cfg);setTier(6);
      
      MAIN_ALUMINIUM = cfg ? IMPURE_ALUMINIUM : ALUMINIUM;
      
      addOD(CLAY_STEEL, DUST, true, true);setTier(7);
      addOD(CLAY_STEEL, INGOT, true, true);setTier(7);
      addOD(CLAY_STEEL, PLATE, true, true);setTier(7);
      add(CLAY_STEEL, LARGE_PLATE, true);setTier(7);
      
      addOD(CLAYIUM, DUST, true, true);setTier(8);
      addOD(CLAYIUM, INGOT, true, true);setTier(8);
      addOD(CLAYIUM, PLATE, true, true);setTier(8);
      add(CLAYIUM, LARGE_PLATE, true);setTier(8);
      
      addOD(ULTIMATE_ALLOY, DUST, true, true);setTier(9);
      addOD(ULTIMATE_ALLOY, INGOT, true, true);setTier(9);
      addOD(ULTIMATE_ALLOY, PLATE, true, true);setTier(9);
      add(ULTIMATE_ALLOY, LARGE_PLATE, true);setTier(9);
      
      addOD(ANTIMATTER, DUST, true, true);setTier(10);
      addOD(ANTIMATTER, GEM, "matter", true, true);setTier(10);
      addOD(ANTIMATTER, PLATE, true, true);setTier(10);
      add(ANTIMATTER, LARGE_PLATE, true);setTier(10);
      
      addOD(PURE_ANTIMATTER, DUST, true, true);setTier(11);
      addOD(PURE_ANTIMATTER, GEM, "matter", true, true);setTier(11);
      addOD(PURE_ANTIMATTER, PLATE, true, true);setTier(11);
      add(PURE_ANTIMATTER, LARGE_PLATE, true);setTier(11);
      
      addOD(COMPRESSED_PURE_ANTIMATTER[1], GEM, "matter", true, true);setTier(11);
      addOD(COMPRESSED_PURE_ANTIMATTER[2], GEM, "matter2", true, true);setTier(11);
      addOD(COMPRESSED_PURE_ANTIMATTER[3], GEM, "matter2", true, true);setTier(11);
      addOD(COMPRESSED_PURE_ANTIMATTER[4], GEM, "matter3", true, true);setTier(12);
      addOD(COMPRESSED_PURE_ANTIMATTER[5], GEM, "matter3", true, true);setTier(12);
      addOD(COMPRESSED_PURE_ANTIMATTER[6], GEM, "matter4", true, true);setTier(12);
      addOD(COMPRESSED_PURE_ANTIMATTER[7], GEM, "matter4", true, true);setTier(12);
      
      add(OCTUPLE_CLAY, DUST, true);setTier(12);
      add(OCTUPLE_CLAY, PLATE, true);setTier(12);
      add(OCTUPLE_CLAY, LARGE_PLATE, true);setTier(12);
      registerMaterialShape(OCTUPLE_CLAY, BLOCK, new ItemStack(CBlocks.blockCompressedClay, 1, 12));
      
      addOD(OCTUPLE_PURE_ANTIMATTER, DUST, true, true);setTier(13);
      addOD(OCTUPLE_PURE_ANTIMATTER, GEM, "matter5", true, true);setTier(13);
      addOD(OCTUPLE_PURE_ANTIMATTER, PLATE, true, true);setTier(13);
      add(OCTUPLE_PURE_ANTIMATTER, LARGE_PLATE, true);setTier(13);
      
      double r = { IMPURE_SILICON, SILICONE, SILICON, ALUMINIUM, CLAY_STEEL, CLAYIUM, ULTIMATE_ALLOY, ANTIMATTER, PURE_ANTIMATTER, OCTUPLE_PURE_ANTIMATTER };double d1 = r.length;
      for (double l = 0; l < d1; l++)
      {
        material = r[l];
      ...
      for (int i = 0; i < 16; i++)
      {
        OreDictionary.registerOre(getODName(SILICONE, BLOCK), new ItemStack(CBlocks.blockSiliconeColored, 1, i));
        OreDictionary.registerOre(getODName(SILICONE, BLOCK) + dyes[(15 - i)], new ItemStack(CBlocks.blockSiliconeColored, 1, i));
      }
      ...
      add(IMPURE_ULTIMATE_ALLOY, INGOT, true);setTier(8);
      ...
      material = impuremetals;CMaterial localCMaterial2 = material.length;
      for (CMaterial metal = 0; metal < localCMaterial2; metal++)
      {
        CMaterial metal = material[metal];
        add(metal, DUST, true);
      }
      metals = new CMaterial[] { ZINCALMINIUM_ALLOY, ZINCONIUM_ALLOY };
      material = metals;CMaterial localCMaterial3 = material.length;
      for (metal = 0; metal < localCMaterial3; metal++)
      {
        CMaterial metal = material[metal];
        addOD(metal, DUST, true, true);setTier(6);
        addOD(metal, INGOT, true, true);setTier(6);
      }
      metals = new CMaterial[] { AZ91D_ALLOY, ZK60A_ALLOY };
      material = metals;CMaterial localCMaterial4 = material.length;
      for (metal = 0; metal < localCMaterial4; metal++)
      {
        CMaterial metal = material[metal];
        addOD(metal, DUST, true, true);setTier(6);
        addOD(metal, INGOT, true, true);setTier(6);
        addOD(metal, PLATE, true, true);setTier(6);
        add(metal, LARGE_PLATE, true);setTier(6);
      }
      ...
      material = metals;CMaterial localCMaterial5 = material.length;
      for (metal = 0; metal < localCMaterial5; metal++)
      {
        CMaterial metal = material[metal];
        addOD(metal, INGOT, true, false);
      }
  ...
  public static void registerMaterialShape(CMaterial material, CShape shape, ItemStack itemStack)
  {
    ...
    ((Map)materialShapeMap.get(material)).put(shape, itemStack);
  }
  ...
  public static boolean addOD(CMaterial material, CShape shape, String iconstr, boolean registerOreDictionary)
  {
    ...
    else
    {
      ...
      if ((list != null) && (list.size() > 0)) {
        registerMaterialShape(material, shape, (ItemStack)list.get(0));
      } else {
  ...
  public static ItemStack get(CMaterial material, CShape shape, int stackSize)
  {
    ...
    if ((materialMap.containsKey(material)) && 
      (((ItemDamaged)materialMap.get(material)).containsKey(shape.name))) {
      return ((ItemDamaged)materialMap.get(material)).getItemStack(shape.name, stackSize);
    }
    if ((shapeMap.containsKey(shape)) && 
      (((ItemDamaged)shapeMap.get(shape)).containsKey(material.name))) {
  ...
  {
    return (CMaterial)materialList.get(Integer.valueOf(id));
  }

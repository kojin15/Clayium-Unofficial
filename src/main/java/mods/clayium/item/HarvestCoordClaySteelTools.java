    ...
    if (!p_77648_2_.isSneaking())
    {
      if ((mode == this.maxRange) && (p_77648_3_.getBlock(p_77648_4_, p_77648_5_, p_77648_6_) == Blocks.clay))
      {
        ...
        if (mat != null)
        {
          ...
          tag.setTag("Coords", coords);p_77648_1_.setTagCompound(tag);
          if (!p_77648_3_.isRemote) {
            p_77648_2_.addChatMessage(new ChatComponentText("Customized."));
          }
          return false;
        }
      }
      ...
      tag.setInteger("Mode", mode);p_77648_1_.setTagCompound(tag);
      if (!p_77648_3_.isRemote) {
        p_77648_2_.addChatMessage(new ChatComponentText("Set mode " + mode + "."));
      }
      return false;
    }

...
public abstract interface IHarvestCoord
{
  public abstract List<Vec3> getHarvestedCoordList(ItemStack paramItemStack, int paramInt1, int paramInt2, int paramInt3, Vec3 paramVec31, Vec3 paramVec32, Vec3 paramVec33);

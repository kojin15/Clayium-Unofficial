  ...
  extends ItemDamaged
{
  ...
  {
    this(capacity, new MultipleIcon(3).addIcons(new String[] { iconName + "_mask", iconName + "_mask", iconName }));
  }
  ...
  public void registerFluidContainer(boolean display)
  {
    ...
    ItemStack empty = getCapsule(null);
    ...
    implements IRecipe, ISpecialResultRecipe
  {
    ...
    public RecipeMap[] getUsageRecipeMap(ItemStack ingredient)
    {
      if ((ingredient != null) && (ingredient.getItem() == this.ingred)) {
        return new RecipeMap[] { new RecipeMap((ItemStack[])getRecipeInput(ingredient.getItemDamage()).toArray(new ItemStack[0]), getRecipeOutput(ingredient.getItemDamage()), "shapeless") };
      }
      return null;
    }
    ...
    public RecipeMap[] getCraftingRecipeMap(ItemStack result)
    {
      if ((result != null) && (result.getItem() == this.result)) {
        return new RecipeMap[] { new RecipeMap((ItemStack[])getRecipeInput(result.getItemDamage()).toArray(new ItemStack[0]), getRecipeOutput(result.getItemDamage()), "shapeless") };
      }
      return null;
    }
  }
    ...
    implements IRecipe, ISpecialResultRecipe
  {
    public RecipeMap[] getUsageRecipeMap(ItemStack ingredient)
    {
      ...
      if ((ingredtemp.getItem() instanceof ItemCapsule))
      {
        ...
        {
          List<RecipeMap> list = new ArrayList();
          ...
          return (RecipeMap[])list.toArray(new RecipeMap[0]);
        }
        return null;
      }

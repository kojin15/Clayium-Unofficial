    ...
    if (modelId == getRenderId())
    {
      if ((block instanceof ClayContainer))
      {
        ...
        if (!((ClayContainer)block).renderAsPipe(world, x, y, z))
        {
          ...
          boolean underlay = ClayContainer.renderPass == 0 ? false : !((ClayContainer)block).isTransparent() ? true : ((ClayContainer)block).isTransparent();
          boolean overlay = ClayContainer.renderPass == 0 ? false : !((ClayContainer)block).isOverlayTransparent() ? true : ((ClayContainer)block).isOverlayTransparent();
          ...
          float f7 = f4;float f8 = f4;float f9 = f4;
          float f10 = f3;float f11 = f5;float f12 = f6;
          float f13 = f3;float f14 = f5;float f15 = f6;
          float f16 = f3;float f17 = f5;float f18 = f6;
          ...
          IIcon[] insertIcons = ((ClayContainer)block1).getInsertIcons(world, x, y, z);IIcon[] extractIcons = ((ClayContainer)block1).getExtractIcons(world, x, y, z);
          ...
          tessellator.setColorOpaque_F(f10, f13, f16);tessellator.setNormal(0.0F, -1.0F, 0.0F);
          ...
          tessellator.setColorOpaque_F(f7, f8, f9);tessellator.setNormal(0.0F, 1.0F, 0.0F);
          ...
          tessellator.setColorOpaque_F(f11, f14, f17);tessellator.setNormal(0.0F, 0.0F, -1.0F);
          ...
          tessellator.setColorOpaque_F(f12, f15, f18);tessellator.setNormal(-1.0F, 0.0F, 0.0F);
        ...
        else
        {
          ...
          IIcon[] insertIcons = block1.getInsertPipeIcons(world, x, y, z);IIcon[] extractIcons = block1.getExtractPipeIcons(world, x, y, z);
          ...
          f4 = directions;f5 = f4.length;
          for (f6 = 0; f6 < f5; f6++)
          {
            UtilDirection direction = f4[f6];

  ...
  implements IItemRenderer
{
  ...
  public void renderItem(IItemRenderer.ItemRenderType type, ItemStack itemstack, Object... data)
  {
    ...
    case EQUIPPED: 
      ...
      for (int x = 0; x < item1.getRenderPasses(itemstack.getItemDamage()); x++)
      {
    ...
    case EQUIPPED_FIRST_PERSON: 
      ...
      for (int x = 0; x < item2.getRenderPasses(itemstack.getItemDamage()); x++)
      {
        int k1 = item2.getColorFromItemStack(itemstack, x);
        float f10 = (k1 >> 16 & 0xFF) / 255.0F;
        float f11 = (k1 >> 8 & 0xFF) / 255.0F;
        float f12 = (k1 & 0xFF) / 255.0F;
        GL11.glColor4f(1.0F * f10, 1.0F * f11, 1.0F * f12, 1.0F);
        ...
        renderItem(entity2, itemstack, x, IItemRenderer.ItemRenderType.EQUIPPED_FIRST_PERSON);
        if ((item2 instanceof IItemExRenderer)) {
    ...
    case INVENTORY: 
      ...
      for (int l = 0; l < item3.getRenderPasses(itemstack.getItemDamage()); l++)
      {
  ...
  private void renderDroppedItem(EntityItem p_77020_1_, IIcon p_77020_2_, int p_77020_3_, float p_77020_4_, float p_77020_5_, float p_77020_6_, float p_77020_7_, int pass)
  {
    ...
    {
      p_77020_5_ = (float)(p_77020_5_ / 1.4D);p_77020_6_ = (float)(p_77020_6_ / 1.4D);p_77020_7_ = (float)(p_77020_7_ / 1.4D);

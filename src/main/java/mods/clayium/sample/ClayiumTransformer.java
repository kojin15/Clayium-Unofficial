  ...
  implements IClassTransformer, Opcodes
{
  ...
  private byte[] hookDoRenderLivingMethod(byte[] bytes)
  {
    ...
    if (mnode != null)
    {
      ...
      overrideList.add(new VarInsnNode(24, 2));
      overrideList.add(new VarInsnNode(24, 4));
      overrideList.add(new VarInsnNode(24, 6));
      overrideList
        .add(new MethodInsnNode(184, "tutorial/test", "passTestRender", "(LEntityLiving;DDD)V"));

...
{
  DOWN(0, -1, 0),  UP(0, 1, 0),  NORTH(0, 0, -1),  SOUTH(0, 0, 1),  WEST(-1, 0, 0),  EAST(1, 0, 0),  DOWNSIDE(0, -1, 0, 1),  UPSIDE(0, 1, 0, 1),  FRONTSIDE(0, 0, -1, 1),  BACKSIDE(0, 0, 1, 1),  LEFTSIDE(-1, 0, 0, 1),  RIGHTSIDE(1, 0, 0, 1),  UNKNOWN(0, 0, 0);
  ...
  public static final UtilDirection[] VALID_DIRECTIONS = { DOWN, UP, NORTH, SOUTH, WEST, EAST, DOWNSIDE, UPSIDE, FRONTSIDE, BACKSIDE, LEFTSIDE, RIGHTSIDE };
  public static final int[] OPPOSITES = { 1, 0, 3, 2, 5, 4 };
  public static final int[] LEFTSIDES = { 4, 4, 4, 5, 3, 2 };
  public static final int[] RIGHTSIDES = { 5, 5, 5, 4, 2, 3 };
  public static final int[] UPSIDES = { 2, 3, 1, 1, 1, 1 };
  public static final int[] DOWNSIDES = { 3, 2, 0, 0, 0, 0 };

...
public class UtilItemStack
{
  ...
  public static int getItemStackHashCode(Iterable items)
  {
    ...
    for (Object item : items) {
      result = 31 * result + (item != null ? item.hashCode() : (item instanceof ItemStack) ? getItemStackHashCode((ItemStack)item) : 0);
    }
    return result;
  }
  ...
  {
    return items2 == null ? false : items1 == null ? false : items2 == null ? true : areStacksEqual(items1.toArray(new Object[0]), items2.toArray(new Object[0]));
  }
  ...
  public static ItemStack[] object2ItemStacks(Object object)
  {
    ...
    if ((object instanceof OreDictionaryStack))
    {
      ...
      ItemStack[] stacks = (ItemStack[])OreDictionary.getOres(odstack.getOreName()).toArray(new ItemStack[0]);
  ...
  public static ItemStack[] tagList2Items(NBTTagList tagList)
  {
    ...
    return list == null ? null : (ItemStack[])list.toArray(new ItemStack[0]);
  }

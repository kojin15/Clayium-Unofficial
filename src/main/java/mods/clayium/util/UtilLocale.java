...
{
  static String[] CENumerals = { "u", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y" };
  
  public static String ClayEnergyNumeral(double ce, boolean flag)
  {
    double n = ce * 10.0D;String s = "";
    if (n == 0.0D) {
  ...
  static String[] SNumerals = { "", "k", "M", "G", "T", "P", "E", "Z", "Y" };
  ...
  protected static String StackSizeNumeral(long stackSize, boolean flag)
  {
    ...
    return s + String.valueOf(d / 100) + (flag2 ? "" : new StringBuilder().append(k % 3 == 0 ? "." : "").append(String.valueOf(d / 10 % 10)).toString()) + (flag1 ? "" : new StringBuilder().append(k % 3 == 1 ? "." : "").append(String.valueOf(d % 10)).toString()) + SNumerals[p];
  }
  ...
  public static String CAResonanceNumeral(double resonance)
  {
    ...
    return StackSizeNumeral(resonance);
  }

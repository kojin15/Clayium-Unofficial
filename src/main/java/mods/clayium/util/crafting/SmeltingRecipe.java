  ...
  extends SimpleMachinesRecipes
{
  ...
  {
    if ((method == methodSmelting) && (tier >= tierSmelting) && (materials != null) && 
      (materials.size() == 1) && 
      (FurnaceRecipes.smelting().getSmeltingResult((ItemStack)materials.get(0)) != null))
    {
  ...
  protected Map getResultMap(List<ItemStack> materials, int method, int tier)
  {
    if ((method == methodSmelting) && (tier >= tierSmelting) && (materials != null) && 
      ...
      (FurnaceRecipes.smelting().getSmeltingResult((ItemStack)materials.get(0)) != null))
    {
      ItemStack result = FurnaceRecipes.smelting().getSmeltingResult((ItemStack)materials.get(0));
  ...
  {
    if ((tier >= tierSmelting) && (materials != null) && 
      (materials.size() == 1) && 
      (FurnaceRecipes.smelting().getSmeltingResult((ItemStack)materials.get(0)) != null)) {
      return true;
    }
  ...
  public Recipes.RecipeResult getRecipeResult(Recipes.RecipeCondition condition)
  {
    ...
    ItemStack result;
    if ((condition.getMethod() == methodSmelting) && (condition.getTier() >= tierSmelting) && 
      (condition.getMaterials() != null) && (condition.getMaterials().length == 1) && ((condition.getMaterials()[0] instanceof ItemStack)) && 
